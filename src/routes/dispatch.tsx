...
import { EmptyState, Kpi, Meta, PageHeader, Panel, StatusBadge, TableShell, Td, Th } from "@/components/wf/ui";
...
export const Route = createFileRoute("/dispatch")({
  ...
  head: () => ({
    meta: [
      { title: "Dispatch Center — WAREFLOW" },
      { name: "description", content: "Carrier handover, tracking generation and dispatch SLA monitoring." },
      { property: "og:title", content: "Dispatch Center — WAREFLOW" },
      { property: "og:description", content: "Manage carrier handover and dispatch SLAs." },
    ],
  }),
  component: () => (
    <AppShell navKey="dispatch">
      <Dispatch />
    </AppShell>
  ),
});
...
function Dispatch() {
  ...
  return (
    <>
      <PageHeader title="Dispatch Center" subtitle="Carrier handover and outbound SLA control" />
