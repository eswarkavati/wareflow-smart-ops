          ...
          <div className="panel p-6">
            ...
            <div className="mt-6 border-t border-border pt-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                {roles.map((r) => (
                  <button
                    ...
                    className="rounded-md border border-border bg-card px-2.5 py-2 text-left text-xs font-medium transition-colors hover:border-primary/50 hover:bg-muted"
                  >
                    {r.role}
                  </button>
                ))}
              ...
              <p className="mt-3 text-[11px] text-muted-foreground">
                Select a role to prefill credentials. Any password with 4+ characters is accepted in demo mode.
              </p>
            </div>
          </div>
        </div>
